...
for SUBDIR in $PARENT_DIR/*/; do
    if [ -d "$SUBDIR" ]; then
        ...
        for MODEL_TYPE in "${MODELS[@]}"; do
            ...
            CMD="python main.py --folder_list ./0_Center/ --side_folder_list ./360/ ./90/ ./180/ ./270/ --inp $INP --model_type $MODEL_TYPE --num_epochs $NUM_EPOCHS --batch_size $BATCH_SIZE --initial_lr $INITIAL_LR --patience $PATIENCE --n_past $N_PAST --n_future $N_FUTURE --lemda $LEMDA --n_units $N_UNITS"
